...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2022 a las 06:09:59
...
(23, 'Press militar con barra sentado', 6, 2, 'Con barra ', 'Cogemos la barra con las manos en pronación (con las palmas mirando hacia adelante). Las manos deben situarse a una anchura algo superior a la de los hombros. Sacamos la barra de su soporte y la colocamos sobre la parte alta de nuestro pecho, a la altura de nuestras clavículas. Esta será la posición de inicio del movimiento. Mantenemos la espalda recta y bien apoyada en el respaldo del banco. Inspiramos y al expulsar el aire levantamos verticalmente la barra por encima de nuestra cabeza, procurando no llegar a bloquear los codos al final del recorrido, sino que se parará un poquito antes. Permaneceremos 1 segundo con los brazos estirados aguantado el peso. Bajamos la barra efectuando el movimiento vertical inverso, de forma controlada, hast'),
(24, 'Press de hombros con mancuernas', 6, 1, 'Con mancuernas', 'Fundamental hacerlo con un peso adecuado que nos permite rigor con la técnica. Subir las mancuernas con un buen impulso, casi explosivamente, descender lentamente, mantener firme el torso y guiar el movimiento de manera suave.'),
(25, 'Elevaciones laterales', 6, 1, 'Con mancuernas', 'Intenta flexionar ligeramente el codo y no extender el brazo por completo. Además, no levantes mucho peso y sube los brazos por encima de la cabeza.');
...
--
ALTER TABLE `ejercicios`
  MODIFY `id_ejer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
